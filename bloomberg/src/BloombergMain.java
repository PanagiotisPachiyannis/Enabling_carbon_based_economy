...
//        // read from the green bonds export file
//        // read from the conventional bonds export file
//        // loop and start matching bonds
//        // make sure each call made to the api is saved locally (written to a file) so that if the limit is reached the work can be transferred to another pc
...
////        for (String s : bloombergMain.greenBondsByIssuer.keySet()) {
////            System.out.println(s);
////        }
////        bloombergMain.readFromExcelGreen("\\\\icnas3.cc.ic.ac.uk\\pp419\\downloads\\bloomberg_api_test_file_green.xlsx");
...
////        List<Map.Entry<String, List<Bond>>> entries = new ArrayList<>(bloombergMain.greenBondsByIssuer.entrySet());
